    ...
    return (
        <section id="hero" className="hero">
            <div className="hero-inner">
                <div className="container hero-content">
                    <div className="hero-text">
                        ...
                        <div className="cta-group">
                            ...
                            <a href="/Andrea_Rottini_CV.pdf" download target="_blank" rel="noreferrer" className="btn btn-secondary">Download CV</a>
                ...
                <div className="container hero-demo-reel">
                    <div className="video-container">
                        {/* Sostituisci l'URL qui sotto con il tuo link di YouTube reale */}
                        <iframe 
